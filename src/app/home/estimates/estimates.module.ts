...
import { AcceptBasicEstimateComponent } from './basic-estimate/accept-basic-estimate/accept-basic-estimate.component';
...
@NgModule({
  ...
  declarations: [
    EstimatesPage,
    AddBasicEstimateComponent,
    AcceptBasicEstimateComponent,
