...
@NgModule({
  declarations: [COMPONENTS, ShipmentInvoiceSummaryComponent, ViewShipmentInvoiceComponent],
  imports: [IMPORTS],
  exports: [IMPORTS, COMPONENTS, ShipmentInvoiceSummaryComponent, ViewShipmentInvoiceComponent],
})
