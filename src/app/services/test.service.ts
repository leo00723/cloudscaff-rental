...
export class PdfService {
  ...
  // SITE INVENTORY PDF
  async generateMasterInventoryList(
      ...
      table: {
        ...
        body: [
          [
            ...
            { text: 'In Use Qty', style: 'h4b', alignment: 'center' },
            { text: 'Reserved Qty', style: 'h4b', alignment: 'center' },
            { text: 'Maintenance Qty', style: 'h4b', alignment: 'center' },
            { text: 'Damaged Qty', style: 'h4b', alignment: 'center' },
            { text: 'Lost Qty', style: 'h4b', alignment: 'center' },
          ],
          ...items,
        ],
      },
